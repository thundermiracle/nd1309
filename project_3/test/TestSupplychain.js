...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.Harvested, "Error: Invalid item State");
  ...
  it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
    ...
    // Inheriting the access control contracts will require you to use the `add()` functions in your truffle tests
    ...
    // Verify the result set
    assert.equal(resultBufferTwo[5], CoffeeState.Processed, "Error: Invalid item State");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferTwo[5], CoffeeState.Packed, "Error: Invalid item State");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.ForSale, "Error: Invalid item State");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.Sold, "Error: Invalid item State");
  ...
  it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferTwo[5], CoffeeState.Shipped, "Error: Invalid item State");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.Received, "Error: Invalid item State");
    assert.equal(resultBufferTwo[6], distributorID, "Error: Invalid distributorID");
  ...
  it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.Purchased, "Error: Invalid item State");
    assert.equal(resultBufferTwo[6], distributorID, "Error: Invalid distributorID");
    assert.equal(resultBufferTwo[7], retailerID, "Error: Invalid retailerID");
  ...
  it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async () => {
    ...
    assert.equal(resultBufferTwo[5], CoffeeState.Purchased, "Error: Invalid itemState");
    assert.equal(resultBufferTwo[6], distributorID, "Error Invalid distributorID");
    assert.equal(resultBufferTwo[7], retailerID, "Error Invalid retailerID");
    assert.equal(resultBufferTwo[8], consumerID, "Error Invalid consumerID");
  });
