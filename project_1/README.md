...
2. To make sure your application is working fine and it creates the Genesis Block you can use POSTMAN to request the Genesis block:
    [http://localhost:8000/block/height/0](http://localhost:8000/block/height/0)
3. Generate new wallet address(or use your exist one)
    ```
    getnewaddress "starRegistry" "legacy"
    ```
4. Make your first request of ownership sending your wallet address: mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u:1622808600:starRegistry
    POST [http://localhost:8000/requestValidation](http://localhost:8000/requestValidation) -> Input JSON body: 
    ```json
    { "address": "mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u" }
    ```
5. Sign the message with your Wallet
    Open BitcoinCore->File->Sign Message
    `Wallet Address`: mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u
    `Message`: mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u:1622808600:starRegistry
    `Result`: H0gn2gTZXDyao3K+nuJvMyfcnkusp9CGMsLGYvfmEvkPN7EnuZY6x1o8hi27JuD3CRkH75CsbgMPzPzasPtVqm8=
6. Submit your Star
     ...
     ```json
     {
        "address": "mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u",
        "message": "mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u:1622808600:starRegistry",
        "signature": "H0gn2gTZXDyao3K+nuJvMyfcnkusp9CGMsLGYvfmEvkPN7EnuZY6x1o8hi27JuD3CRkH75CsbgMPzPzasPtVqm8=",
        "star": {
            "dec": "68° 52' 56.9",
            "ra": "16h 29m 1.0s",
            "story": "Testing the story 4"
...
7. Retrieve Stars owned by me
    [http://localhost:8000/blocks/mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u](http://localhost:8000/blocks/mgeMNZb9QqqZ2iwFVKBTufByUnZVMT7q2u)