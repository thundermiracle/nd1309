...
contract ERC721 is Pausable, ERC165 {
  ...
  function approve(address to, uint256 tokenId) public {
    ...
    require(
      msg.sender == ownerOfToken || isApprovedForAll(ownerOfToken, msg.sender),
      "Message sender must be the owner or has been approved by token owner"
    );
  ...
  function _transferFrom(
    ...
    address to,
    uint256 tokenId
  ) internal virtual requireValidAddress(to) {
...
contract ERC721TokenRealEstate is ERC721Metadata {
  constructor()
    ERC721Metadata(
      "ThunderMiracle-RealEstate",
      "TM-RE",
