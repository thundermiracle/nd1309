...
abstract contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner requireValidAddress(newOwner) {
...
abstract contract Pausable is Ownable {
    ...
    modifier withNotPaused() {
        require(!_paused, "Contract is not available now");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOfToken != to, "Given address should not be the owner of the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOfToken || isApprovedForAll(ownerOfToken, msg.sender), "Message sender must be the owner or has been approved by token owner");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal virtual requireValidAddress(to) {
        // TODO revert if given tokenId already exists or given address is invalid
        require(_tokenOwner[tokenId] == address(0), "token is already exist");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal virtual requireValidAddress(to) {
...
contract ERC721Metadata is ERC721Enumerable, usingProvable {
    ...
    constructor (string memory c_name, string memory c_symbol, string memory c_baseTokenURI) {
        // TODO: set instance var values
        _name = c_name;
        _symbol = c_symbol;
        _baseTokenURI = c_baseTokenURI;
    ...
    function _setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "tokenId is not exist");
...
contract CustomERC721Token is ERC721Metadata {
    constructor() ERC721Metadata("ThunderMiracle-RealEstate", "TM-RE", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
    }
